...
export class CreateCommandProvider implements CommandProvider<CommandSuffix.Create> {
    ...
    constructor(private instanceCreator: InstanceCreator, private instanceStore: InstanceStore) {
    }
    ...
    async execute(): Promise<void> {
        ...
        const terminalCommands = await this.instanceCreator.toTerminalCommands(this.parse(request));
