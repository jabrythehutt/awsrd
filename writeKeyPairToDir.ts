...
export async function writeKeyPairToDir(keyPair: KeyPairSyncResult<string, string>, destinationDir: string): Promise<{ privateKeyPath: string; publicKeyPath: string }> {
