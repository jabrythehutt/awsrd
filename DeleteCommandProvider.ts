...
export class DeleteCommandProvider implements CommandProvider<CommandSuffix.Delete, string> {
    constructor(private instanceStore: InstanceStore, private instanceDeleter: InstanceDeleter) {
    }
